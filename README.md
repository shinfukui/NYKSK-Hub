...
<style>
  :root {
    ...
    --shadow-lg: 0 12px 48px rgba(26,20,16,0.18);
  }
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .pin-btn:hover { background: var(--ink); color: var(--paper); border-color: var(--ink); transform: scale(1.04); }
  .pin-btn:active { transform: scale(0.96); }
  .pin-btn.del { font-size: 16px; color: var(--gray); }
  ...
  <div class="login-box">
    <div class="login-mon">
      <svg viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle cx="30" cy="30" r="28" stroke="#c9a84c" stroke-width="2"/>
        <circle cx="30" cy="30" r="22" stroke="#c9a84c" stroke-width="1" opacity="0.5"/>
        <line x1="12" y1="12" x2="48" y2="48" stroke="#1a1410" stroke-width="2.5" stroke-linecap="round"/>
        <line x1="48" y1="12" x2="12" y2="48" stroke="#1a1410" stroke-width="2.5" stroke-linecap="round"/>
    ...
    <div class="dojo-brand">
      <div class="dojo-mon">
        <svg viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <circle cx="30" cy="30" r="22" stroke="#c9a84c" stroke-width="1" opacity="0.5"/>
          <!-- Shinai crossed -->
          <line x1="12" y1="12" x2="48" y2="48" stroke="#f5f0e8" stroke-width="2.5" stroke-linecap="round"/>
          <line x1="48" y1="12" x2="12" y2="48" stroke="#f5f0e8" stroke-width="2.5" stroke-linecap="round"/>
          <!-- Guard circles -->
          <circle cx="30" cy="30" r="5" fill="#c0392b"/>
          <circle cx="30" cy="30" r="3" fill="#c9a84c"/>
        </svg>
